...
if ($search != '') {
    $query = "SELECT * FROM mahasiswa WHERE nama_mahasiswa LIKE '%$search%' OR prodi LIKE '%$search%'";
} else {
                        ...
                        <form action="<?php echo isset($data_edit['id']) ? 'edit_data.php?id=' . $data_edit['id'] . '&proses=1' : 'percobaan8.php'; ?>" method="POST" enctype="multipart/form-data">
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" class="input-xlarge focused" id="file" name="file">
                                    </div>
                                </div>
                    ...
                    <div class="span12">
                        ...
                        <form method="GET" action="" class="form-inline">
                            <div class="input-group">
                                <input type="text" name="search" placeholder="Ketik Nama Mahasiswa / Prodi" class="form-control" value="<?php echo $search; ?>">
                        ...
                        <form action="export_csv.php" method="POST" style="margin-top: 10px;">
                            <button type="submit" class="btn btn-success">Ekspor ke CSV</button>
                        </form>

                        <button onclick="printTable()" class="btn btn-primary" style="margin-top: 10px;">Cetak Tabel</button>
                        <table class="table" id="mahasiswaTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($data['file']) { ?>
                                            <a href="upload/<?php echo $data['file'] ?>" target="_blank">Unduh</a>
                                        <?php } else { ?>
                                            Tidak ada file
                                        <?php } ?>
                                    </td>
